...
RECODE RPARENT_WITHIN_HOUR (0=0) (1,2,3 = 1) INTO RPARENT_WITHIN_HOUR_DUMMY.
FREQUENCIES RPARENT_WITHIN_HOUR_DUMMY.

VALUE LABELS RPARENT_WITHIN_HOUR_DUMMY 1'Either both parents, only a father, or only a mother live within an hour' 0'no parent lives within an hour'.
